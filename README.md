...
- Maximum-coverage setlist selection with previous-concert song exclusion, backlog support, drag-and-drop set ordering, and final-set Telegram notifications
