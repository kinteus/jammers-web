export const DEFAULT_LINEUP = [
  { key: "vocals", label: "Vocals", seatCount: 3, allowOptional: true, displayOrder: 1 },
  { key: "guitar", label: "Guitar", seatCount: 2, allowOptional: true, displayOrder: 2 },
  { key: "bass", label: "Bass", seatCount: 1, allowOptional: true, displayOrder: 3 },
  { key: "drums", label: "Drums", seatCount: 1, allowOptional: true, displayOrder: 4 },
